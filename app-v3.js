...
// Evento do botão de atualização no cabeçalho (dispara o GitHub Actions na nuvem com a tela azul de progresso)
btnRefreshLocal.addEventListener('click', triggerGitHubUpdate);
